...
print(paste0("Number of genes with one count in at least two samples: ", nrow(dds)))	# 13,240
...
rld <- rlog(dds, blind = FALSE)	# This gives warnings and suggests vst
...
if (!file.exists("GF04.Salmon.Heatmap.png")){
	png("GF04.Salmon.Heatmap.png")
...
if (!file.exists("GF04.Salmon.PCA.png")){
	png("GF04.Salmon.PCA.png")

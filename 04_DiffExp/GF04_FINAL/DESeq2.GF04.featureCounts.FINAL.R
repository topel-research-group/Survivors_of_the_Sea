...
if (file.exists("dds.rds")){
	...
	if (!file.exists("GF04.featureCounts.Heatmap.svg")){
		svg("GF04.featureCounts.Heatmap.svg")
	...
	if (!file.exists("GF04.featureCounts.PCA.svg")){
		svg("GF04.featureCounts.PCA.svg")
	...
	if (!file.exists("GF04.featureCounts.PCA.RestingZoom.svg")){
		svg("GF04.featureCounts.PCA.RestingZoom.svg")
		p <- plotPCA(rld, intgroup = c("Dormancy","Batch"))
